...
window.darkmode = darkmode;//have to set function to global window state to call from html otherwise directly set button onclick function through javascript
function lightmode() {
